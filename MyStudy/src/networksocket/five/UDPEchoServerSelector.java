...
public class UDPEchoServerSelector {
	...
	private static final int ECHOMAX = 255; // Maxinum size of echo datagram
	...
	public static void main(String[] args) throws IOException {
		...
		while(true){	// Run forever,receiving and echoing datagrams
			...
			while(keyIter.hasNext()){
				...
				// Client socket channel is aailable for writing and
	...
	public static void handleWrite(SelectionKey key) throws IOException {
		...
		int bytesSend=channel.send(clntRec.buffer, clntRec.clientAddress);
		if(bytesSend!=0){	// Buffer completely written?
