 ...
 * @author Rod Johnson
 */
public class Log4jLoggerFactory implements ticket.java14.java.util.logging.LoggerFactory, InitializingBean {
	...
	public ticket.java14.java.util.logging.Logger getLogger(String name) {
