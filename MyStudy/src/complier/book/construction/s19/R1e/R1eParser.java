...
public class R1eParser implements R1eConstants {
	private R1eSymTab st;
	private R1eTokenMgr tm;
	private R1eCodeGen cg;
	private Token currentToken;
	private Token previousToken;

	public R1eParser(R1eSymTab st, R1eTokenMgr tm, R1eCodeGen cg) {
		this.st = st;
		this.tm = tm;
		this.cg = cg;
