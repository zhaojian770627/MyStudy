 ...
 * org/mortbay/start/start.config" file obtained as a resource or file. This can
 * be overridden with the START system property. The format of each line in this
 * file is:
 * 
 * <PRE>
 * 
 ...
 */
public class Main {
	static boolean _debug = true;// System.getProperty("DEBUG",null)!=null;
	...
	public void invokeMain(ClassLoader classloader, String classname,
		...
		if (_version) {
			System.err.println(invoked_class.getPackage()
