 ...
 * 
 * This class implements the methods of the JDBC3.0 version of PreparedStatement
 * each one throwing a SQLException with the name of the method. A concrete
 * subclass can then just implement the methods not implemented here and
 * override any methods it needs to implement for correct functionality.
 * 
 */
public abstract class UpdatableVTITemplate implements PreparedStatement {
	...
	//
	// java.sql.PreparedStatement calls, passed through to our
	// preparedStatement.
	//
