...
<%@ page import="ticket.business.boxoffice.BoxOffice" %>
<%@ page import="ticket.business.exceptions.NoSuchPerformanceException" %>
<%@ page import="ticket.business.boxoffice.ejb.*" %>


<jsp:useBean id="queryBean" 
	class="ticket.web.Model1Bean"
	scope="session">
